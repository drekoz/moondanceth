            ...
            <div class="container-full-width">
                <div class="row row-space-2">
                    <div class="col-sm-6 sm-margin-b-4">
                        <img class="img-responsive" src="<?php echo base_url('assets/img/970x647/01.jpg'); ?>" alt="Image">
                    </div>
                    <div class="col-sm-6">
                        <img class="img-responsive" src="<?php echo base_url('assets/img/970x647/03.jpg'); ?>" alt="Image">
                    </div>
                </div>
                <!--// end row -->
            </div>
